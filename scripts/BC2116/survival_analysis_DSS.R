...
KM_Plot_List <- list()
KM_Plot_List[["ER_Pos"]] <- GENE_EXP_ER_P %>% select(DSS_TIME, DSS_EVENT, Fn14_TERT_GROUP, Fn14_TERT)
KM_Plot_List[["PR_Pos"]] <- GENE_EXP_PR_P %>% select(DSS_TIME, DSS_EVENT, Fn14_TERT_GROUP, Fn14_TERT)
KM_Plot_List[["HR_Pos"]]<- GENE_EXP_HR_P %>% select(DSS_TIME, DSS_EVENT, Fn14_TERT_GROUP, Fn14_TERT)
KM_Plot_List[["HR_Pos_Endo_Mono_T"]]<- GENE_EXP_HR_P_Endo_Mono_T %>% select(DSS_TIME, DSS_EVENT, Fn14_TERT_GROUP, Fn14_TERT)
KM_Plot_List[["HR_Pos_Chemo_Endo"]]<- GENE_EXP_HR_P_Chemo_Endo %>% select(DSS_TIME, DSS_EVENT, Fn14_TERT_GROUP, Fn14_TERT)
